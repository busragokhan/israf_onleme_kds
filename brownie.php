...
?>
<?php
$sql = "SELECT SUM(getirtilme_satis.getirtilme_sayisi) FROM getirtilme_satis WHERE urun_id = 5";
...
<?php
$sql = "SELECT SUM(getirtilme_satis.satis_sayisi) FROM getirtilme_satis WHERE urun_id = 5";
$result = mysqli_query($conn, $sql);
...
<?php
$sql = "SELECT SUM(getirtilme_satis.getirtilme_sayisi) - SUM(getirtilme_satis.satis_sayisi) FROM getirtilme_satis WHERE urun_id = 5";
$result = mysqli_query($conn, $sql);
...
$sql = "select getirtilme_satis.getirtilme_sayisi, getirtilme_satis.satis_sayisi from getirtilme_satis inner join urunler on getirtilme_satis.urun_id = urunler.urun_id inner join aylar on getirtilme_satis.ay_id = aylar.ay_id where urunler.urun_ad = 'Brownie' ";
